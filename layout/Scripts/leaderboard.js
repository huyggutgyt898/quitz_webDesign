function leaderboardData() {
    return {
        ...
        hotQuestions: [
            { title: "10 câu đố mẹo chỉ 1% người giải được", author: "Thầy Giáo Ba", plays: "168.2k" },
            { title: "Ai là tỷ phú Việt Nam đầu tiên?", author: "Quiz Master", plays: "142.3k" },
            { title: "Đoán tên bài hát qua emoji", author: "Music Lover", plays: "129.7k" },
            { title: "Bạn thuộc nhà nào trong Harry Potter?", author: "Hogwarts VN", plays: "115.4k" },
            { title: "Trắc nghiệm MBTI siêu chính xác 2025", author: "Tâm Lý 24h", plays: "98.6k" },
            { title: "Đố bạn biết: Con gì có 8 chân?", author: "Đố Vui VN", plays: "87.1k" },
            { title: "Câu hỏi tư duy logic khó nhất", author: "Brain Master", plays: "79.3k" },
            { title: "Đố vui về địa lý Việt Nam", author: "Việt Nam 247", plays: "72.8k" },
            { title: "Bạn sẽ sống sót trong phim kinh dị không?", author: "Horror Quiz", plays: "65.9k" },
            { title: "Kiếp trước bạn là ai?", author: "Tử Vi 24h", plays: "61.2k" },
        ],
        top10Followers: [
